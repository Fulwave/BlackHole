...
#define                             kBox_UID                            "BH_H_%ich_UID"
static CFStringRef                  gBox_Name                           = NULL;
static Boolean                      gBox_Acquired                       = true;

#define                             kDevice_UID                         "BH_H_%ich_UID"
#define                             kDevice_ModelUID                    "BH_H_%ich_ModelUID"
...
#define                             kDataSource_ItemNamePattern         "BH_H %ich"

#define                             DEVICE_NAME                         "BH_H %ich"

...
#define                             kBox_UID                            "BH_E_%ich_UID"
static CFStringRef                  gBox_Name                           = NULL;
static Boolean                      gBox_Acquired                       = true;

#define                             kDevice_UID                         "BH_E_%ich_UID"
#define                             kDevice_ModelUID                    "BH_E_%ich_ModelUID"
...
#define                             kDataSource_ItemNamePattern         "BH_E %ich"

#define                             DEVICE_NAME                         "BH_E %ich"
